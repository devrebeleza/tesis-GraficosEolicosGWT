...
import com.paquete.graficos.eolicos.basededatos.DatosFrecuenciaVelocidad;
...
//				for(int velocidad= 0; (velocidad <= maximaVelocidad) && (insertaOk) ; velocidad ++){
				for(double velocidad= 0; (velocidad <= maximaVelocidad) && (insertaOk) ; velocidad = velocidad + finVelocidad){
					inicioVelocidad = velocidad;
					finVelocidad = velocidad + 0.03;
