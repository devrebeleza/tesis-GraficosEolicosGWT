...
public class DatosDireccionVientoRangosSource extends DataSource {

  private static DatosDireccionVientoRangosSource instance = null;
  private String nombreTabla = "DireccionVientoRangos";
  public static DatosDireccionVientoRangosSource getInstance(){
      if(instance == null){
        instance = new DatosDireccionVientoRangosSource("DatosDireccionVientoRangos_XML");
      }
      return instance;
  }
  
  public DatosDireccionVientoRangosSource(String id){
    
    setID(id);

    setRecordXPath("/List/"+nombreTabla);
//      este id debería ocultarse
      DataSourceIntegerField  idDatosField = new DataSourceIntegerField("idDireccionVientoRangos", "ID", 50,true);
...
//      DataSourceDateTimeField horaField = new DataSourceDateTimeField("hora", "Hora");      
      ...
      DataSourceTextField divisionField = new DataSourceTextField("division", "Division", 100);
...
//      definimos DataSourceField para poder tomar el valor como un float y posteriormente trabajarlo en el ListGrid
    ...
    System.out.println("despues de llamar a tabla en DatosDireccionVientoRangosSource");
